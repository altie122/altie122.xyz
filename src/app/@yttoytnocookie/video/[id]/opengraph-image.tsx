...
import { getytdata } from "@/lib/@yt-to-ytnocookie/ytdata.server";
...
export default async function Image({
  ...
  const interRomanLatinVar = await readFile(
    join(process.cwd(), "assets/yt-to-ytnocookie/inter-roman-latin-var.woff"),
  );

  const socialBackground = await readFile(
    join(process.cwd(), "assets/yt-to-ytnocookie/social-background.png"),
  );
