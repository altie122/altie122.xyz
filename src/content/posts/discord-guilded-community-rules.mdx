...
authors: ["altie"]
image:
  cover: ../../assets/images/blog/discord-guilded-community-rules/default-thumbnail.png
  alt: Channel Banner
tags:
  - Community
relatedPosts: ["community-rules"]
isHidden: true
---
...
<Banner title="Outdated" type="Warning">
  Details on this post are outdated, please see the updated version, [here](/blog/posts/community-rules).
</Banner>
